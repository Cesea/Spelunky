...
#define JAR_PARTICLE_MAX_NUM 16

#define BONE_PARTICLE_SPRITE_NUM 8
#define BONE_PARTICLE_MAX_NUM 16

#define BACKBONE_PARTICLE_SPRITE_NUM 8
#define BACKBONE_PARTICLE_MAX_NUM 16

#define THORN_PARTICLE_SPRITE_NUM 8
#define THORN_PARTICLE_MAX_NUM 16

#define WOOD_PARTICLE_SPRITE_NUM 8
#define WOOD_PARTICLE_MAX_NUM 16
