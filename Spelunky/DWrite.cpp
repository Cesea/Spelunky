...
void DWrite::PrintText(ID2D1HwndRenderTarget *renderTarget, float x, float y, const WCHAR * str, const D2D1_COLOR_F &brushColor)
{
	ID2D1SolidColorBrush *brush = nullptr;
	renderTarget->CreateSolidColorBrush(brushColor, &brush);

	D2D1_RECT_F layoutRect = { x, y, 1000, 500 };
